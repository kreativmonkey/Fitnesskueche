...
\newcommand\kochbuchversion{Ver. 0.4}
...
\renewcommand{\std}{\,Std.}
\newcommand{\pck}{\,Pck.}
\newcommand{\msp}{\,Msp.}
\newcommand{\pr}{\,Pr.}
\newcommand{\gestr}{\,gestr.}
\newcommand{\btl}{\,Btl.}
...
\begin{titlepage}
		...
		\end{center}
		\ThisCenterWallPaper{1}{./bilder/start3.jpg}
		% Bildquelle start3.jpg: \href{https://www.flickr.com/photos/21045446@N00/14687568609/}{jh_tan84} auf flickr
...
\input{./rezepte/falscher_reis.tex}
\input{./rezepte/fitness_mayonnaise.tex}
\input{./rezepte/rapsoel_mayonnaise.tex}
...
\input{./rezepte/thunfischfrikadellen_mit_asia_salat.tex}
\input{./rezepte/putenbruststreifen_mit_erdnusssauce.tex}
\input{./rezepte/veggie_burger.tex}
\input{./rezepte/lachsfilet_mit_spinat_und_avocadosalat.tex}
\input{./rezepte/gegrilltes_haehnchen_mit_griechischem_salat.tex}
\input{./rezepte/gebackene_suesskartoffel_mit_avocado_paprika_dip.tex}
...
\input{./rezepte/bananen_pancake.tex}
\input{./rezepte/bananen_quark_waffeln.tex}

%\section{Getränke} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Getränke


\section{Smoothies} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Smoothies
\input{./rezepte/afterworkout-beerenmix.tex}
